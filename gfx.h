...
struct SGFX{
    ...
    uint8  LastScreen [MAX_SNES_WIDTH * MAX_SNES_HEIGHT * 4]; // obsoleted
};
...
extern void (*S9xCustomDisplayString) (const char *string, int lines, bool linesFromBottom, int pixelsFromLeft, bool allowWrap); // called instead of S9xDisplayString if set to non-NULL

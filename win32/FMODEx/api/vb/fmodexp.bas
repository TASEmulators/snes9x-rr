...
Public Const FMOD_VERSION As Long = &H42206
...
Public Declare Function FMOD_Memory_Initialize Lib "fmodexp.dll" (ByVal poolmem As Long, ByVal poollen As Long, ByVal useralloc As Long, ByVal userrealloc As Long, ByVal userfree As Long) As FMOD_RESULT
Public Declare Function FMOD_Memory_GetStats Lib "fmodexp.dll" (ByRef currentalloced As Long, ByRef maxalloced As Long) As FMOD_RESULT

Public Declare Function FMOD_Debug_SetLevel Lib "fmodexp.dll" (ByVal level As FMOD_DEBUGLEVEL) As FMOD_RESULT
Public Declare Function FMOD_Debug_GetLevel Lib "fmodexp.dll" (ByRef level As FMOD_DEBUGLEVEL) As FMOD_RESULT
Public Declare Function FMOD_File_SetDiskBusy Lib "fmodexp.dll" (ByVal busy As Long) As FMOD_RESULT
Public Declare Function FMOD_File_GetDiskBusy Lib "fmodexp.dll" (ByRef busy As Long) As FMOD_RESULT

'
'FMOD System factory functions.  Use this to create an FMOD System Instance.  below you will see FMOD_System_Init/Close to get started.
'

Public Declare Function FMOD_System_Create Lib "fmodexp.dll" (ByRef system As Long) As FMOD_RESULT
Public Declare Function FMOD_System_Release Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_SetOutput Lib "fmodexp.dll" (ByVal system As Long, ByVal output As FMOD_OUTPUTTYPE) As FMOD_RESULT
Public Declare Function FMOD_System_GetOutput Lib "fmodexp.dll" (ByVal system As Long, ByRef output As FMOD_OUTPUTTYPE) As FMOD_RESULT
Public Declare Function FMOD_System_GetNumDrivers Lib "fmodexp.dll" (ByVal system As Long, ByRef Numdrivers As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetDriverInfo Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef name As Byte, ByVal namelen As Long, ByRef GUID As FMOD_GUID) As FMOD_RESULT
Public Declare Function FMOD_System_GetDriverCaps Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef caps As FMOD_CAPS, ByRef minfrequency As Long, ByRef maxfrequency As Long, ByRef controlpanelspeakermode As FMOD_SPEAKERMODE) As FMOD_RESULT
Public Declare Function FMOD_System_SetDriver Lib "fmodexp.dll" (ByVal system As Long, ByVal Driver As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetDriver Lib "fmodexp.dll" (ByVal system As Long, ByRef Driver As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetHardwareChannels Lib "fmodexp.dll" (ByVal system As Long, ByVal Min2d As Long, ByVal Max2d As Long, ByVal Min3d As Long, ByVal Max3d As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetSoftwareChannels Lib "fmodexp.dll" (ByVal system As Long, ByVal Numsoftwarechannels As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetSoftwareChannels Lib "fmodexp.dll" (ByVal system As Long, ByRef Numsoftwarechannels As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetSoftwareFormat Lib "fmodexp.dll" (ByVal system As Long, ByVal Samplerate As Long, ByVal Format As FMOD_SOUND_FORMAT, ByVal Numoutputchannels As Long, ByVal Maxinputchannels As Long, ByVal Resamplemethod As FMOD_DSP_RESAMPLER) As FMOD_RESULT
Public Declare Function FMOD_System_GetSoftwareFormat Lib "fmodexp.dll" (ByVal system As Long, ByRef Samplerate As Long, ByRef Format As FMOD_SOUND_FORMAT, ByRef Numoutputchannels As Long, ByRef Maxinputchannels As Long, ByRef Resamplemethod As FMOD_DSP_RESAMPLER, ByRef Bits As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetDSPBufferSize Lib "fmodexp.dll" (ByVal system As Long, ByVal Bufferlength As Long, ByVal Numbuffers As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetDSPBufferSize Lib "fmodexp.dll" (ByVal system As Long, ByRef Bufferlength As Long, ByRef Numbuffers As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetFileSystem Lib "fmodexp.dll" (ByVal system As Long, ByVal useropen As Long, ByVal userclose As Long, ByVal userread As Long, ByVal userseek As Long, ByVal Buffersize As Long) As FMOD_RESULT
Public Declare Function FMOD_System_AttachFileSystem Lib "fmodexp.dll" (ByVal system As Long, ByVal useropen As Long, ByVal userclose As Long, ByVal userread As Long, ByVal userseek As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetAdvancedSettings Lib "fmodexp.dll" (ByVal system As Long, ByRef settings As FMOD_ADVANCEDSETTINGS) As FMOD_RESULT
Public Declare Function FMOD_System_GetAdvancedSettings Lib "fmodexp.dll" (ByVal system As Long, ByRef settings As FMOD_ADVANCEDSETTINGS) As FMOD_RESULT
Public Declare Function FMOD_System_SetSpeakerMode Lib "fmodexp.dll" (ByVal system As Long, ByVal Speakermode As FMOD_SPEAKERMODE) As FMOD_RESULT
Public Declare Function FMOD_System_GetSpeakerMode Lib "fmodexp.dll" (ByVal system As Long, ByRef Speakermode As FMOD_SPEAKERMODE) As FMOD_RESULT

'
'Plug-in support
'

Public Declare Function FMOD_System_SetPluginPath Lib "fmodexp.dll" (ByVal system As Long, ByVal Path As String) As FMOD_RESULT
Public Declare Function FMOD_System_LoadPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Filename As String, ByRef Handle As Long, ByVal Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_System_UnloadPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Handle As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetNumPlugins Lib "fmodexp.dll" (ByVal system As Long, ByVal Plugintype As FMOD_PLUGINTYPE, ByRef Numplugins As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetPluginHandle Lib "fmodexp.dll" (ByVal system As Long, ByVal Plugintype As FMOD_PLUGINTYPE, ByVal Index As Long, ByRef Handle As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetPluginInfo Lib "fmodexp.dll" (ByVal system As Long, ByVal Handle As Long, ByRef Plugintype As FMOD_PLUGINTYPE, ByRef name As Byte, ByVal namelen As Long, ByRef version As Long) As FMOD_RESULT

Public Declare Function FMOD_System_SetOutputByPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Handle As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetOutputByPlugin Lib "fmodexp.dll" (ByVal system As Long, ByRef Handle As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateDSPByPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Handle As Long, ByRef dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateCodec Lib "fmodexp.dll" (ByVal system As Long, ByVal CodecDescription As Long) As FMOD_RESULT
'
'Init/Close
'

Public Declare Function FMOD_System_Init Lib "fmodexp.dll" (ByVal system As Long, ByVal Maxchannels As Long, ByVal Flags As FMOD_INITFLAGS, ByVal Extradriverdata As Long) As FMOD_RESULT
Public Declare Function FMOD_System_Close Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT

'
'General post-init system functions
'

Public Declare Function FMOD_System_Update Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT

Public Declare Function FMOD_System_Set3DSettings Lib "fmodexp.dll" (ByVal system As Long, ByVal Dopplerscale As Single, ByVal Distancefactor As Single, ByVal Rolloffscale As Single) As FMOD_RESULT
Public Declare Function FMOD_System_Get3DSettings Lib "fmodexp.dll" (ByVal system As Long, ByRef Dopplerscale As Single, ByRef Distancefactor As Single, ByRef Rolloffscale As Single) As FMOD_RESULT
Public Declare Function FMOD_System_Set3DNumListeners Lib "fmodexp.dll" (ByVal system As Long, ByVal Numlisteners As Long) As FMOD_RESULT
Public Declare Function FMOD_System_Get3DNumListeners Lib "fmodexp.dll" (ByVal system As Long, ByRef Numlisteners As Long) As FMOD_RESULT
Public Declare Function FMOD_System_Set3DListenerAttributes Lib "fmodexp.dll" (ByVal system As Long, ByVal Listener As Long, ByRef Pos As FMOD_VECTOR, ByRef Vel As FMOD_VECTOR, ByRef Forward As FMOD_VECTOR, ByRef Up As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_System_Get3DListenerAttributes Lib "fmodexp.dll" (ByVal system As Long, ByVal Listener As Long, ByRef Pos As FMOD_VECTOR, ByRef Vel As FMOD_VECTOR, ByRef Forward As FMOD_VECTOR, ByRef Up As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_System_Set3DRolloffCallback Lib "fmodexp.dll" (ByVal system As Long, ByVal Callback As Long) As FMOD_RESULT
Public Declare Function FMOD_System_Set3DSpeakerPosition Lib "fmodexp.dll" (ByVal system As Long, ByVal speaker As FMOD_SPEAKER, ByVal X As Single, ByVal Y As Single, ByVal active As Long) As FMOD_RESULT
Public Declare Function FMOD_System_Get3DSpeakerPosition Lib "fmodexp.dll" (ByVal system As Long, ByRef speaker As FMOD_SPEAKER, ByRef X As Single, ByRef Y As Single, ByRef active As Long) As FMOD_RESULT

Public Declare Function FMOD_System_SetStreamBufferSize Lib "fmodexp.dll" (ByVal system As Long, ByVal Filebuffersize As Long, ByVal Filebuffersizetype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_System_GetStreamBufferSize Lib "fmodexp.dll" (ByVal system As Long, ByRef Filebuffersize As Long, ByRef Filebuffersizetype As FMOD_TIMEUNIT) As FMOD_RESULT

'
'System information functions.
'

Public Declare Function FMOD_System_GetVersion Lib "fmodexp.dll" (ByVal system As Long, ByRef version As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetOutputHandle Lib "fmodexp.dll" (ByVal system As Long, ByRef Handle As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetChannelsPlaying Lib "fmodexp.dll" (ByVal system As Long, ByRef Channels As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetHardwareChannels Lib "fmodexp.dll" (ByVal system As Long, ByRef Num2d As Long, ByRef Num3d As Long, ByRef total As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetCPUUsage Lib "fmodexp.dll" (ByVal system As Long, ByRef Dsp As Single, ByRef Stream As Single, ByRef Update As Single, ByRef total As Single) As FMOD_RESULT
Public Declare Function FMOD_System_GetSoundRAM Lib "fmodexp.dll" (ByVal system As Long, ByRef currentalloced As Long, ByRef maxalloced As Long, ByRef total As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetNumCDROMDrives Lib "fmodexp.dll" (ByVal system As Long, ByRef Numdrives As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetCDROMDriveName Lib "fmodexp.dll" (ByVal system As Long, ByVal Drive As Long, ByRef Drivename As Byte, ByVal Drivenamelen As Long, ByRef Scsiname As Byte, ByVal Scsinamelen As Long, ByRef Devicename As Byte, ByVal Devicenamelen As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetSpectrum Lib "fmodexp.dll" (ByVal system As Long, ByRef Spectrumarray As Single, ByVal Numvalues As Long, ByVal Channeloffset As Long, ByRef Windowtype As FMOD_DSP_FFT_WINDOW) As FMOD_RESULT
Public Declare Function FMOD_System_GetWaveData Lib "fmodexp.dll" (ByVal system As Long, ByRef Wavearray As Single, ByVal Numvalues As Long, ByVal Channeloffset As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_CreateSoundEx Lib "fmodexp.dll" Alias "FMOD_System_CreateSound" (ByVal system As Long, ByVal Name_or_data As String, ByVal Mode As FMOD_MODE, ByRef exinfo As FMOD_CREATESOUNDEXINFO, ByRef Sound As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateStreamEx Lib "fmodexp.dll" Alias "FMOD_System_CreateStream" (ByVal system As Long, ByVal Name_or_data As String, ByVal Mode As FMOD_MODE, ByRef exinfo As FMOD_CREATESOUNDEXINFO, ByRef Sound As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateDSP Lib "fmodexp.dll" (ByVal system As Long, ByRef description As FMOD_DSP_DESCRIPTION, ByRef Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateDSPByType Lib "fmodexp.dll" (ByVal system As Long, ByVal dsptype As FMOD_DSP_TYPE, ByRef Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateDSPByIndex Lib "fmodexp.dll" (ByVal system As Long, ByVal Index As Long, ByRef Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateChannelGroup Lib "fmodexp.dll" (ByVal system As Long, ByVal name As String, ByRef Channelgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateSoundGroup Lib "fmodexp.dll" (ByVal system As Long, ByRef name As Byte, ByRef soundgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_System_CreateReverb Lib "fmodexp.dll" (ByVal system As Long, ByRef reverb As Long) As FMOD_RESULT

Public Declare Function FMOD_System_PlaySound Lib "fmodexp.dll" (ByVal system As Long, ByVal channelid As FMOD_CHANNELINDEX, ByVal Sound As Long, ByVal paused As Long, ByRef channel As Long) As FMOD_RESULT
Public Declare Function FMOD_System_PlayDSP Lib "fmodexp.dll" (ByVal system As Long, ByVal channelid As FMOD_CHANNELINDEX, ByVal Dsp As Long, ByVal paused As Long, ByRef channel As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetChannel Lib "fmodexp.dll" (ByVal system As Long, ByVal channelid As Long, ByRef channel As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetMasterChannelGroup Lib "fmodexp.dll" (ByVal system As Long, ByRef Channelgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetMasterSoundGroup Lib "fmodexp.dll" (ByVal system As Long, ByRef soundgroup As Long) As FMOD_RESULT

'
'Reverb API
'

Public Declare Function FMOD_System_SetReverbProperties Lib "fmodexp.dll" (ByVal system As Long, ByRef Prop As FMOD_REVERB_PROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_System_GetReverbProperties Lib "fmodexp.dll" (ByVal system As Long, ByRef Prop As FMOD_REVERB_PROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_System_SetReverbAmbientProperties Lib "fmodexp.dll" (ByVal system As Long, ByRef Prop As FMOD_REVERB_PROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_System_GetReverbAmbientProperties Lib "fmodexp.dll" (ByVal system As Long, ByRef Prop As FMOD_REVERB_PROPERTIES) As FMOD_RESULT
...
Public Declare Function FMOD_System_GetDSPHead Lib "fmodexp.dll" (ByVal system As Long, ByRef Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_System_AddDSP Lib "fmodexp.dll" (ByVal system As Long, ByVal Dsp As Long, ByRef dspconnection As Long) As FMOD_RESULT
Public Declare Function FMOD_System_LockDSP Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT
Public Declare Function FMOD_System_UnlockDSP Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT

'
'Recording API
'

Public Declare Function FMOD_System_GetRecordNumDrivers Lib "fmodexp.dll" (ByVal system As Long, ByRef Numdrivers As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetRecordDriverInfo Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef name As Byte, ByVal namelen As Long, ByRef GUID As FMOD_GUID) As FMOD_RESULT
Public Declare Function FMOD_System_GetRecordPosition Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef position As Long) As FMOD_RESULT

Public Declare Function FMOD_System_RecordStart Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByVal Sound As Long, ByVal Loop_ As Long) As FMOD_RESULT
Public Declare Function FMOD_System_RecordStop Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long) As FMOD_RESULT
Public Declare Function FMOD_System_IsRecording Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef Recording As Long) As FMOD_RESULT

'
'Geometry API
'

Public Declare Function FMOD_System_CreateGeometry Lib "fmodexp.dll" (ByVal system As Long, ByVal MaxPolygons As Long, ByVal MaxVertices As Long, ByRef Geometryf As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetGeometrySettings Lib "fmodexp.dll" (ByVal system As Long, ByVal Maxworldsize As Single) As FMOD_RESULT
Public Declare Function FMOD_System_GetGeometrySettings Lib "fmodexp.dll" (ByVal system As Long, ByRef Maxworldsize As Single) As FMOD_RESULT
Public Declare Function FMOD_System_LoadGeometry Lib "fmodexp.dll" (ByVal system As Long, ByVal Data As Long, ByVal DataSize As Long, ByRef Geometry As Long) As FMOD_RESULT

'
'Network functions
'

Public Declare Function FMOD_System_SetNetworkProxy Lib "fmodexp.dll" (ByVal system As Long, ByVal Proxy As String) As FMOD_RESULT
Public Declare Function FMOD_System_GetNetworkProxy Lib "fmodexp.dll" (ByVal system As Long, ByRef Proxy As Byte, ByVal Proxylen As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetNetworkTimeout Lib "fmodexp.dll" (ByVal system As Long, ByVal timeout As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetNetworkTimeout Lib "fmodexp.dll" (ByVal system As Long, ByRef timeout As Long) As FMOD_RESULT

'
'Userdata set/get
'

Public Declare Function FMOD_System_SetUserData Lib "fmodexp.dll" (ByVal system As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetUserData Lib "fmodexp.dll" (ByVal system As Long, ByRef userdata As Long) As FMOD_RESULT

'
'Sound' API
'

Public Declare Function FMOD_Sound_Release Lib "fmodexp.dll" (ByVal Sound As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetSystemObject Lib "fmodexp.dll" (ByVal Sound As Long, ByRef system As Long) As FMOD_RESULT

'
'Standard sound manipulation functions.
'

Public Declare Function FMOD_Sound_Lock Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Offset As Long, ByVal Length As Long, ByRef Ptr1 As Long, ByRef Ptr2 As Long, ByRef Len1 As Long, ByRef Len2 As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_Unlock Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Ptr1 As Long, ByVal Ptr2 As Long, ByVal Len1 As Long, ByVal Len2 As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_SetDefaults Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Frequency As Single, ByVal volume As Single, ByVal Pan As Single, ByVal Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetDefaults Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Frequency As Single, ByRef volume As Single, ByRef Pan As Single, ByRef Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_SetVariations Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Frequencyvar As Single, ByVal Volumevar As Single, ByVal Panvar As Single) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetVariations Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Frequencyvar As Single, ByRef Volumevar As Single, ByRef Panvar As Single) As FMOD_RESULT
Public Declare Function FMOD_Sound_Set3DMinMaxDistance Lib "fmodexp.dll" (ByVal Sound As Long, ByVal min As Single, ByVal max As Single) As FMOD_RESULT
Public Declare Function FMOD_Sound_Get3DMinMaxDistance Lib "fmodexp.dll" (ByVal Sound As Long, ByRef min As Single, ByRef max As Single) As FMOD_RESULT
Public Declare Function FMOD_Sound_Set3DConeSettings Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Insideconeangle As Single, ByVal Outsideconeangle As Single, ByVal Outsidevolume As Single) As FMOD_RESULT
Public Declare Function FMOD_Sound_Get3DConeSettings Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Insideconeangle As Single, ByRef Outsideconeangle As Single, ByRef Outsidevolume As Single) As FMOD_RESULT
Public Declare Function FMOD_Sound_Set3DCustomRolloff Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Points As FMOD_VECTOR, ByVal numpoints As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_Get3DCustomRolloff Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Points As Long, ByRef numpoints As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_SetSubSound Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Index As Long, ByVal Subsound As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetSubSound Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Index As Long, ByRef Subsound As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_SetSubSoundSentence Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Subsoundlist As Long, ByVal Numsubsounds As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetName Lib "fmodexp.dll" (ByVal Sound As Long, ByRef name As Byte, ByVal namelen As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetLength Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Length As Long, ByVal Lengthtype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetFormat Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Soundtype As FMOD_SOUND_TYPE, ByRef Format As FMOD_SOUND_FORMAT, ByRef Channels As Long, ByRef Bits As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetNumSubSounds Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Numsubsounds As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetNumTags Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Numtags As Long, ByRef Numtagsupdated As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetTag Lib "fmodexp.dll" (ByVal Sound As Long, ByVal name As String, ByVal Index As Long, ByRef Tag As FMOD_TAG) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetOpenState Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Openstate As FMOD_OPENSTATE, ByRef Percentbuffered As Long, ByRef Starving As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_ReadData Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Buffer As Long, ByVal Lenbytes As Long, ByRef Read As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_SeekData Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Pcm As Long) As FMOD_RESULT

Public Declare Function FMOD_Sound_SetSoundGroup Lib "fmodexp.dll" (ByVal Sound As Long, ByVal soundgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetSoundGroup Lib "fmodexp.dll" (ByVal Sound As Long, ByRef soundgroup As Long) As FMOD_RESULT

'
'Synchronization point API.  These points can come from markers embedded in wav files, and can also generate channel callbacks.
'

Public Declare Function FMOD_Sound_GetNumSyncPoints Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Numsyncpoints As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetSyncPoint Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Index As Long, ByRef Point As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetSyncPointInfo Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Point As Long, ByRef name As Byte, ByVal namelen As Long, ByRef Offset As Long, ByVal Offsettype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_Sound_AddSyncPoint Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Offset As Long, ByVal Offsettype As FMOD_TIMEUNIT, ByVal name As String, ByRef Point As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_DeleteSyncPoint Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Point As Long) As FMOD_RESULT

'
'Functions also in Channel class but here they are the 'default' to save having to change it in Channel all the time.
'

Public Declare Function FMOD_Sound_SetMode Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Mode As FMOD_MODE) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetMode Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Mode As FMOD_MODE) As FMOD_RESULT
Public Declare Function FMOD_Sound_SetLoopCount Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Loopcount As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetLoopCount Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Loopcount As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_SetLoopPoints Lib "fmodexp.dll" (ByVal Sound As Long, ByVal Loopstart As Long, ByVal Loopstarttype As FMOD_TIMEUNIT, ByVal Loopend As Long, ByVal Loopendtype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetLoopPoints Lib "fmodexp.dll" (ByVal Sound As Long, ByRef Loopstart As Long, ByVal Loopstarttype As FMOD_TIMEUNIT, ByRef Loopend As Long, ByVal Loopendtype As FMOD_TIMEUNIT) As FMOD_RESULT

'
'For MOD/S3M/XM/IT/MID sequenced formats only.
'
Public Declare Function FMOD_Sound_GetMusicNumChannels Lib "fmodexp.dll" (ByVal Sound As Long, ByRef numchannels As Long)
Public Declare Function FMOD_Sound_SetMusicChannelVolume Lib "fmodexp.dll" (ByVal Sound As Long, ByVal channel As Long, ByVal volume As Single)
Public Declare Function FMOD_Sound_GetMusicChannelVolume Lib "fmodexp.dll" (ByVal Sound As Long, ByVal channel As Long, ByRef volume As Single)

'
'Userdata set/get.
'

Public Declare Function FMOD_Sound_SetUserData Lib "fmodexp.dll" (ByVal Sound As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_Sound_GetUserData Lib "fmodexp.dll" (ByVal Sound As Long, ByRef userdata As Long) As FMOD_RESULT

'
'Channel' API
'

Public Declare Function FMOD_Channel_GetSystemObject Lib "fmodexp.dll" (ByVal channel As Long, ByRef system As Long) As FMOD_RESULT

Public Declare Function FMOD_Channel_Stop Lib "fmodexp.dll" (ByVal channel As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetPaused Lib "fmodexp.dll" (ByVal channel As Long, ByVal paused As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetPaused Lib "fmodexp.dll" (ByVal channel As Long, ByRef paused As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetVolume Lib "fmodexp.dll" (ByVal channel As Long, ByVal volume As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetVolume Lib "fmodexp.dll" (ByVal channel As Long, ByRef volume As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetFrequency Lib "fmodexp.dll" (ByVal channel As Long, ByVal Frequency As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetFrequency Lib "fmodexp.dll" (ByVal channel As Long, ByRef Frequency As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetPan Lib "fmodexp.dll" (ByVal channel As Long, ByVal Pan As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetPan Lib "fmodexp.dll" (ByVal channel As Long, ByRef Pan As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetDelay Lib "fmodexp.dll" (ByVal channel As Long, ByVal Startdelay As Long, ByVal Enddelay As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetDelay Lib "fmodexp.dll" (ByVal channel As Long, ByRef Startdelay As Long, ByRef Enddelay As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetSpeakerMix Lib "fmodexp.dll" (ByVal channel As Long, ByVal Frontleft As Single, ByVal Frontright As Single, ByVal Center As Single, ByVal Lfe As Single, ByVal Backleft As Single, ByVal Backright As Single, ByVal Sideleft As Single, ByVal Sideright As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetSpeakerMix Lib "fmodexp.dll" (ByVal channel As Long, ByRef Frontleft As Single, ByRef Frontright As Single, ByRef Center As Single, ByRef Lfe As Single, ByRef Backleft As Single, ByRef Backright As Single, ByRef Sideleft As Single, ByRef Sideright As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetSpeakerLevels Lib "fmodexp.dll" (ByVal channel As Long, ByVal speaker As FMOD_SPEAKER, ByRef levels As Single, ByVal numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetSpeakerLevels Lib "fmodexp.dll" (ByVal channel As Long, ByVal speaker As FMOD_SPEAKER, ByRef levels As Single, ByVal numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetInputChannelMix Lib "fmodexp.dll" (ByVal channel As Long, ByRef levels As Single, ByVal numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetInputChannelMix Lib "fmodexp.dll" (ByVal channel As Long, ByRef levels As Single, ByVal numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetMute Lib "fmodexp.dll" (ByVal channel As Long, ByVal mute As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetMute Lib "fmodexp.dll" (ByVal channel As Long, ByRef mute As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetPriority Lib "fmodexp.dll" (ByVal channel As Long, ByVal Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetPriority Lib "fmodexp.dll" (ByVal channel As Long, ByRef Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetPosition Lib "fmodexp.dll" (ByVal channel As Long, ByVal position As Long, ByVal Postype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetPosition Lib "fmodexp.dll" (ByVal channel As Long, ByRef position As Long, ByVal Postype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetReverbProperties Lib "fmodexp.dll" (ByVal channel As Long, ByRef Prop As FMOD_REVERB_CHANNELPROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetReverbProperties Lib "fmodexp.dll" (ByVal channel As Long, ByRef Prop As FMOD_REVERB_CHANNELPROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetChannelGroup Lib "fmodexp.dll" (ByVal channel As Long, ByVal Channelgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetChannelGroup Lib "fmodexp.dll" (ByVal channel As Long, ByRef Channelgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetCallback Lib "fmodexp.dll" (ByVal channel As Long, ByVal Callback As Long) As FMOD_RESULT

'
'3D functionality.
'

Public Declare Function FMOD_Channel_Set3DAttributes Lib "fmodexp.dll" (ByVal channel As Long, ByRef Pos As FMOD_VECTOR, ByRef Vel As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DAttributes Lib "fmodexp.dll" (ByVal channel As Long, ByRef Pos As FMOD_VECTOR, ByRef Vel As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DMinMaxDistance Lib "fmodexp.dll" (ByVal channel As Long, ByVal mindistance As Single, ByVal maxdistance As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DMinMaxDistance Lib "fmodexp.dll" (ByVal channel As Long, ByRef mindistance As Single, ByRef maxdistance As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DConeSettings Lib "fmodexp.dll" (ByVal channel As Long, ByVal Insideconeangle As Single, ByVal Outsideconeangle As Single, ByVal Outsidevolume As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DConeSettings Lib "fmodexp.dll" (ByVal channel As Long, ByRef Insideconeangle As Single, ByRef Outsideconeangle As Single, ByRef Outsidevolume As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DConeOrientation Lib "fmodexp.dll" (ByVal channel As Long, ByRef Orientation As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DConeOrientation Lib "fmodexp.dll" (ByVal channel As Long, ByRef Orientation As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DCustomRolloff Lib "fmodexp.dll" (ByVal channel As Long, ByRef Points As FMOD_VECTOR, ByVal numpoints As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DCustomRolloff Lib "fmodexp.dll" (ByVal channel As Long, ByRef Points As Long, ByRef numpoints As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DOcclusion Lib "fmodexp.dll" (ByVal channel As Long, ByVal DirectOcclusion As Single, ByVal ReverbOcclusion As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DOcclusion Lib "fmodexp.dll" (ByVal channel As Long, ByRef DirectOcclusion As Single, ByRef ReverbOcclusion As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DSpread Lib "fmodexp.dll" (ByVal channel As Long, ByVal angle As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DSpread Lib "fmodexp.dll" (ByVal channel As Long, ByRef angle As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DPanLevel Lib "fmodexp.dll" (ByVal channel As Long, ByVal float As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DPanLevel Lib "fmodexp.dll" (ByVal channel As Long, ByRef float As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Set3DDopplerLevel Lib "fmodexp.dll" (ByVal channel As Long, ByVal level As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_Get3DDopplerLevel Lib "fmodexp.dll" (ByVal channel As Long, ByRef level As Single) As FMOD_RESULT

'
'DSP functionality only for channels playing sounds created with FMOD_SOFTWARE.
'

Public Declare Function FMOD_Channel_GetDSPHead Lib "fmodexp.dll" (ByVal channel As Long, ByRef Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_AddDSP Lib "fmodexp.dll" (ByVal channel As Long, ByVal Dsp As Long, ByRef dspconnection As Long) As FMOD_RESULT

'
'Information only functions.
'

Public Declare Function FMOD_Channel_IsPlaying Lib "fmodexp.dll" (ByVal channel As Long, ByRef Isplaying As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_IsVirtual Lib "fmodexp.dll" (ByVal channel As Long, ByRef Isvirtual As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetAudibility Lib "fmodexp.dll" (ByVal channel As Long, ByRef Audibility As Single) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetCurrentSound Lib "fmodexp.dll" (ByVal channel As Long, ByRef Sound As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetSpectrum Lib "fmodexp.dll" (ByVal channel As Long, ByRef Spectrumarray As Single, ByVal Numvalues As Long, ByVal Channeloffset As Long, ByVal Windowtype As FMOD_DSP_FFT_WINDOW) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetWaveData Lib "fmodexp.dll" (ByVal channel As Long, ByRef Wavearray As Single, ByVal Numvalues As Long, ByVal Channeloffset As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetIndex Lib "fmodexp.dll" (ByVal channel As Long, ByRef Index As Long) As FMOD_RESULT

'
'Functions also found in Sound class but here they can be set per channel.
'

Public Declare Function FMOD_Channel_SetMode Lib "fmodexp.dll" (ByVal channel As Long, ByVal Mode As FMOD_MODE) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetMode Lib "fmodexp.dll" (ByVal channel As Long, ByRef Mode As FMOD_MODE) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetLoopCount Lib "fmodexp.dll" (ByVal channel As Long, ByVal Loopcount As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetLoopCount Lib "fmodexp.dll" (ByVal channel As Long, ByRef Loopcount As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_SetLoopPoints Lib "fmodexp.dll" (ByVal channel As Long, ByVal Loopstart As Long, ByVal Loopstarttype As FMOD_TIMEUNIT, ByVal Loopend As Long, ByVal Loopendtype As FMOD_TIMEUNIT) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetLoopPoints Lib "fmodexp.dll" (ByVal channel As Long, ByRef Loopstart As Long, ByVal Loopstarttype As FMOD_TIMEUNIT, ByRef Loopend As Long, ByVal Loopendtype As FMOD_TIMEUNIT) As FMOD_RESULT

'
'Userdata set/get.
'

Public Declare Function FMOD_Channel_SetUserData Lib "fmodexp.dll" (ByVal channel As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_Channel_GetUserData Lib "fmodexp.dll" (ByVal channel As Long, ByRef userdata As Long) As FMOD_RESULT

'
'ChannelGroup' API
'

Public Declare Function FMOD_ChannelGroup_Release Lib "fmodexp.dll" (ByVal Channelgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetSystemObject Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef system As Long) As FMOD_RESULT

'
'Channelgroup scale values.  (scales the current volume or pitch of all channels and channel groups, DOESN'T overwrite)
'

Public Declare Function FMOD_ChannelGroup_SetVolume Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal volume As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetVolume Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef volume As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_SetPitch Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Pitch As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetPitch Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Pitch As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_SetPaused Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal paused As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetPaused Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef paused As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_SetMute Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal mute As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetMute Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef mute As Long) As FMOD_RESULT

'
'Channelgroup override values.  (recursively overwrites whatever settings the channels had)
'

Public Declare Function FMOD_ChannelGroup_Stop Lib "fmodexp.dll" (ByVal Channelgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_OverrideVolume Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal volume As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_OverrideFrequency Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Frequency As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_OverridePan Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Pan As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_OverrideReverbProperties Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Prop As FMOD_REVERB_CHANNELPROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_Override3DAttributes Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Pos As FMOD_VECTOR, ByRef Vel As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_OverrideSpeakerMix Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Frontleft As Single, ByVal Frontright As Single, ByVal Center As Single, ByVal Lfe As Single, ByVal Backleft As Single, ByVal Backright As Single, ByVal Sideleft As Single, ByVal Sideright As Single) As FMOD_RESULT

'
'Nested channel groups.
'
Public Declare Function FMOD_ChannelGroup_AddGroup Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Group As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetNumGroups Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Numgroups As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetGroup Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Index As Long, ByRef Group As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetParentGroup Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Group As Long) As FMOD_RESULT

'
'DSP functionality only for channel groups playing sounds created with FMOD_SOFTWARE.
'

Public Declare Function FMOD_ChannelGroup_GetDSPHead Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_AddDSP Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Dsp As Long, ByRef dspconnection As Long) As FMOD_RESULT

'
'Information only functions.
'

Public Declare Function FMOD_ChannelGroup_GetName Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef name As Byte, ByVal namelen As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetNumChannels Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Numchannels As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetChannel Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Index As Long, ByRef channel As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetSpectrum Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Spectrumarray As Single, ByVal Numvalues As Long, ByVal Channeloffset As Long, ByVal Windowtype As FMOD_DSP_FFT_WINDOW) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetWaveData Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef Wavearray As Single, ByVal Numvalues As Long, ByVal Channeloffset As Long) As FMOD_RESULT

'
'Userdata set/get.
'

Public Declare Function FMOD_ChannelGroup_SetUserData Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_GetUserData Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByRef userdata As Long) As FMOD_RESULT

'
'SoundGroup' API
'

Public Declare Function FMOD_SoundGroup_Release Lib "fmodexp.dll" (ByVal soundgroup As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetSystemObject Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef system As Long) As FMOD_RESULT

'
'SoundGroup control functions.
'

Public Declare Function FMOD_SoundGroup_SetMaxAudible Lib "fmodexp.dll" (ByVal soundgroup As Long, ByVal maxaudible As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetMaxAudible Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef maxaudible As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_SetMaxAudibleBehavior Lib "fmodexp.dll" (ByVal soundgroup As Long, ByVal behavior As FMOD_SOUNDGROUP_BEHAVIOR) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetMaxAudibleBehavior Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef behavior As FMOD_SOUNDGROUP_BEHAVIOR) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_SetMuteFadeSpeed Lib "fmodexp.dll" (ByVal soundgroup As Long, ByVal speed As Single) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetMuteFadeSpeed Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef speed As Single) As FMOD_RESULT

'
'Information only functions.
'

Public Declare Function FMOD_SoundGroup_GetName Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef name As Byte, ByVal namelen As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetNumSounds Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef numsounds As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetSound Lib "fmodexp.dll" (ByVal soundgroup As Long, ByVal Index As Long, ByRef Sound As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetNumPlaying Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef numplaying As Long) As FMOD_RESULT

'
'Userdata set/get.
'

Public Declare Function FMOD_SoundGroup_SetUserData Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_SoundGroup_GetUserData Lib "fmodexp.dll" (ByVal soundgroup As Long, ByRef userdata As Long) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_Release Lib "fmodexp.dll" (ByVal Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetSystemObject Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef system As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_AddInput Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Target As Long, ByRef dspconnection As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_DisconnectFrom Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Target As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_DisconnectAll Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal inputs As Long, ByVal outputs As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_Remove Lib "fmodexp.dll" (ByVal Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetNumInputs Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef Numinputs As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetNumOutputs Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef Numoutputs As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetInput Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef input_ As Long, ByRef InputConnection As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutput Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef output As Long, ByRef OutputConnection As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetActive Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal active As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetActive Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef active As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetBypass Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Bypass As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetBypass Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef Bypass As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_Reset Lib "fmodexp.dll" (ByVal Dsp As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetParameter Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Value As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetParameter Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef Value As Single, ByRef Valuestr As Byte, ByVal Valuestrlen As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetNumParameters Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef Numparams As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetParameterInfo Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef name As Byte, ByRef label As Byte, ByRef description As Byte, ByVal Descriptionlen As Long, ByRef min As Single, ByRef max As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_ShowConfigDialog Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Hwnd As Long, ByVal Show As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetInfo Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef name As Byte, ByRef version As Long, ByRef Channels As Long, ByRef Configwidth As Long, ByRef Configheight As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetType Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef type_ As FMOD_DSP_TYPE) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetDefaults Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Frequency As Single, ByVal volume As Single, ByVal Pan As Single, ByVal Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetDefaults Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef Frequency As Single, ByRef volume As Single, ByRef Pan As Single, ByRef Priority As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetUserData Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetUserData Lib "fmodexp.dll" (ByVal Dsp As Long, ByRef userdata As Long) As FMOD_RESULT

'
'DSP Connection API.
'

Public Declare Function FMOD_DSPConnection_GetInput Lib "fmodexp.dll" (ByVal dspconnection As Long, ByRef input_ As Long)
Public Declare Function FMOD_DSPConnection_GetOutput Lib "fmodexp.dll" (ByVal dspconnection As Long, ByRef output As Long)
Public Declare Function FMOD_DSPConnection_SetMix Lib "fmodexp.dll" (ByVal dspconnection As Long, ByVal volume As Single)
Public Declare Function FMOD_DSPConnection_GetMix Lib "fmodexp.dll" (ByVal dspconnection As Long, ByRef volume As Single)
Public Declare Function FMOD_DSPConnection_SetLevels Lib "fmodexp.dll" (ByVal dspconnection As Long, ByVal speaker As FMOD_SPEAKER, ByRef levels As Single, ByVal numlevels As Long)
Public Declare Function FMOD_DSPConnection_GetLevels Lib "fmodexp.dll" (ByVal dspconnection As Long, ByVal speaker As FMOD_SPEAKER, ByRef levels As Single, ByVal numlevels As Long)
Public Declare Function FMOD_DSPConnection_SetUserData Lib "fmodexp.dll" (ByVal dspconnection As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_DSPConnection_GetUserData Lib "fmodexp.dll" (ByVal dspconnection As Long, ByRef userdata As Long) As FMOD_RESULT
...
Public Declare Function FMOD_Geometry_Release Lib "fmodexp.dll" (ByVal Gemoetry As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_AddPolygon Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal DirectOcclusion As Single, ByVal ReverbOcclusion As Single, ByVal DoubleSided As Long, ByVal NumVertices As Long, ByRef Vertices As FMOD_VECTOR, ByRef PolygonIndex As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetNumPolygons Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef NumPolygons As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetMaxPolygons Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef MaxPolygons As Long, ByRef MaxVertices As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetPolygonNumVertices Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal PolygonIndex As Long, ByRef NumVertices As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetPolygonVertex Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal PolygonIndex As Long, ByVal VertexIndex As Long, ByRef Vertex As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetPolygonVertex Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal PolygonIndex As Long, ByVal VertexIndex As Long, ByRef Vertex As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetPolygonAttributes Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal PolygonIndex As Long, ByVal DirectOcclusion As Single, ByVal ReverbOcclusion As Single, ByVal DoubleSided As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetPolygonAttributes Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal PolygonIndex As Long, ByRef DirectOcclusion As Single, ByRef ReverbOcclusion As Single, ByRef DoubleSided As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetActive Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal active As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetActive Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef active As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetRotation Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef Forward As FMOD_VECTOR, ByRef Up As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetRotation Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef Forward As FMOD_VECTOR, ByRef Up As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetPosition Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef position As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetPosition Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef position As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetScale Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef Scale_ As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetScale Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef Scale_ As FMOD_VECTOR) As FMOD_RESULT
Public Declare Function FMOD_Geometry_Save Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal Data As Long, ByRef DataSize As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_SetUserData Lib "fmodexp.dll" (ByVal Geometry As Long, ByVal userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_Geometry_GetUserData Lib "fmodexp.dll" (ByVal Geometry As Long, ByRef userdata As Long) As FMOD_RESULT

'
'Reverb' API
'

Public Declare Function FMOD_Reverb_Release Lib "fmodexp.dll" (ByVal reverb As Long)

'
'Reverb manipulation.
'

Public Declare Function FMOD_Reverb_Set3DAttributes Lib "fmodexp.dll" (ByVal reverb As Long, ByRef position As FMOD_VECTOR, ByVal mindistance As Single, ByVal maxdistance As Single) As FMOD_RESULT
Public Declare Function FMOD_Reverb_Get3DAttributes Lib "fmodexp.dll" (ByVal reverb As Long, ByRef position As FMOD_VECTOR, ByRef mindistance As Single, ByRef maxdistance As Single) As FMOD_RESULT
Public Declare Function FMOD_Reverb_SetProperties Lib "fmodexp.dll" (ByVal reverb As Long, ByRef properties As FMOD_REVERB_PROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_Reverb_GetProperties Lib "fmodexp.dll" (ByVal reverb As Long, ByRef properties As FMOD_REVERB_PROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_Reverb_SetActive Lib "fmodexp.dll" (ByVal reverb As Long, ByVal active As Long) As FMOD_RESULT
Public Declare Function FMOD_Reverb_GetActive Lib "fmodexp.dll" (ByVal reverb As Long, ByRef active As Long) As FMOD_RESULT

'
'Userdata set/get.
'

Public Declare Function FMOD_Reverb_SetUserData Lib "fmodexp.dll" (ByVal reverb As Long, ByRef userdata As Long) As FMOD_RESULT
Public Declare Function FMOD_Reverb_GetUserData Lib "fmodexp.dll" (ByVal reverb As Long, ByRef userdata As Long) As FMOD_RESULT

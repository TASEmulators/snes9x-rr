...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00042206;
    ...
    */
    public class EventSystem
    {
        ...
        {
            return FMOD_EventSystem_RegisterMemoryFSB(eventsystemraw, filename, fsbdata, fsbdatalen, 0);
        }
        ...
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_EventSystem_RegisterMemoryFSB(IntPtr eventsystem, string filename, IntPtr fsbdata, uint fsbdatalen, int loadintorsx);
        [DllImport(EVENT_VERSION.dll)]
    ...
    */
    public class EventGroup
    {
        ...
        public RESULT getProperty(string propertyname, ref IntPtr _value)
        {
            return FMOD_EventGroup_GetProperty(eventgroupraw, propertyname, ref _value);
        }
        public RESULT getPropertyByIndex(int propertyindex, ref IntPtr _value)
        {
            return FMOD_EventGroup_GetPropertyByIndex(eventgroupraw, propertyindex, ref _value);
        }
        ...
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_EventGroup_GetProperty(IntPtr eventgroup, string propertyname, ref IntPtr _value);
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_EventGroup_GetPropertyByIndex(IntPtr eventgroup, int propertyindex, ref IntPtr _value);
        [DllImport(EVENT_VERSION.dll)]
    ...
    */
    public class Event
    {
        ...
        public RESULT getProperty(string propertyname, ref IntPtr _value, bool this_instance)
        {
            return FMOD_Event_GetProperty(eventraw, propertyname, ref _value, (this_instance ? 1 : 0));
        }
        public RESULT getPropertyByIndex(int propertyindex, ref IntPtr _value, bool this_instance)
        {
            return FMOD_Event_GetPropertyByIndex(eventraw, propertyindex, ref _value, (this_instance ? 1 : 0));
        }
        ...
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_Event_GetProperty(IntPtr _event, string propertyname, ref IntPtr _value, int this_instance);
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_Event_GetPropertyByIndex(IntPtr _event, int propertyindex, ref IntPtr _value, int this_instance);
        [DllImport(EVENT_VERSION.dll)]

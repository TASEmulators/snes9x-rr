...
#define DISCLAIMER_TEXT        "%s.\r\n" \
        ...
        "(c) Copyright 2002 - 2006  Brad Jorsch, funkyass, Kris Bleakley, Nach, zones\r\n\r\n" \
        "Windows Port Authors: Matthew Kendora, funkyass, nitsuja, Nach, blip.\r\n\r\n" \
...
#define MOVIE_INFO_ACTION_DEFERRED "Action deferred until end of frame."

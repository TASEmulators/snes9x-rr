...
int main (int /*argc*/, char ** /*argv*/)
{
    ...
    OFFSET4(NextAPUTimerPos,NextAPUTimerPos)

    OFFSET6(CPUSpeed,Speed)
    OFFSET6(CPUOpcodes,S9xOpcodes)
    OFFSET6(CPUOpLengths,S9xOpLengths)
    ...
    OFFSET7(UseWIPAPUTiming,UseWIPAPUTiming)
    OFFSET7(BG_Forced,BG_Forced)
    ...
    OFFSET9(HDMA,HDMA)
    OFFSET9(HDMAStarted,HDMAStarted)
    ...
    OFFSET11(SA1OpLengths,S9xOpLengths)

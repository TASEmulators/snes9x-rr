...
int CurrentState = 0; // TODO: this CurrentState is dummy
#define inputDisplayString ""
#define currFrameCounter 0
#define lagFrameCounter 0
...
void HudStruct::reset()
{
	FrameCounter.x=0;
	FrameCounter.y=5;
	FrameCounter.xsize=120;
	FrameCounter.ysize=10;

	InputDisplay.x=0;
	InputDisplay.y=25;
	InputDisplay.xsize=60;
	InputDisplay.ysize=10;

	LagFrameCounter.x=0;
	LagFrameCounter.y=45;
	LagFrameCounter.xsize=120;

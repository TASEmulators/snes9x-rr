...
void S9xUpdateHVTimerPosition (void)
{
	...
	{
		PPU.HTimerPosition -= (short)Timings.H_Max;
		PPU.VTimerPosition++;
		// FIXME
		...
		switch (Address)
		{
		  ...
		  case 0x2106:
			...
			// Mosaic pixel size and enable
				FLUSH_REDRAW();
				PPU.MosaicStart=(uint8)CPU.V_Counter;
...
void S9xSoftResetPPU ()
{
	...
	PPU.VTimerEnabled = FALSE;
	PPU.HTimerEnabled = FALSE;
	PPU.HTimerPosition = (short)Timings.H_Max + 1;
	PPU.VTimerPosition = (short)Timings.V_Max + 1;
	PPU.Mosaic = 0;
